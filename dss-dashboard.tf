      ...
      "targets": [
        {
          ...
          "query": "@log_group:\"/aws/lambda/dss-notify-${var.deployment_stage}\" AND @message:\"Successfully delivered Notification\"",
          "refId": "A",
          "timeField": "@timestamp"
        },
        {
          ...
          "query": "@log_group:\"/aws/lambda/dss-notify-${var.deployment_stage}\" AND @message:\"Failed delivering\"",
          "refId": "C",
          "timeField": "@timestamp"
        }
      ],
