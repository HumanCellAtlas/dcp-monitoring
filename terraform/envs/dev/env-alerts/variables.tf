locals {
  ...
  azul_indexer_health_check_id    = "${data.terraform_remote_state.env-health-checks.azul_indexer_health_check_id}"
  azul_webservice_health_check_id = "${data.terraform_remote_state.env-health-checks.azul_webservice_health_check_id}"
  data_browser_health_check_id    = "${data.terraform_remote_state.env-health-checks.data_browser_health_check_id}"
}
