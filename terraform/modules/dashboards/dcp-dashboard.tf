  ...
  value = <<EOF
{
  ...
  "panels": [
      ...
      "targets": [
        {
          "$hashKey": "object:273",
          "dimensions": {
            "HealthCheckId": "${module.health_checks.dcp_health_check_id}"
          },
      ...
      "targets": [
        {
          "$hashKey": "object:265",
          "dimensions": {
            "HealthCheckId": "${module.health_checks.ingest_health_check_id}"
          },
          "metricName": "HealthCheckStatus",
          "namespace": "AWS/Route53",
          "period": "",
      ...
      "targets": [
        {
          "$hashKey": "object:807",
          "dimensions": {
            "HealthCheckId": "${module.health_checks.upload_health_check_id}"
          },
          "metricName": "HealthCheckStatus",
          "namespace": "AWS/Route53",
          "period": "",
      ...
      "targets": [
        {
          "$hashKey": "object:125",
          "dimensions": {
            "HealthCheckId": "${module.health_checks.dss_health_check_id}"
          },
          "metricName": "HealthCheckStatus",
          "namespace": "AWS/Route53",
          "period": "",
      ...
      "targets": [
        {
          "$hashKey": "object:265",
          "dimensions": {
            "HealthCheckId": "${module.health_checks.analysis_health_check_id}"
          },
          "metricName": "HealthCheckStatus",
          "namespace": "AWS/Route53",
          "period": "",
      ...
      "targets": [
        {
          "$hashKey": "object:807",
          "dimensions": {
            "HealthCheckId": "${module.health_checks.logs_health_check_id}"
          },
          "metricName": "HealthCheckStatus",
          "namespace": "AWS/Route53",
          "period": "",
    ...
    },
    {
      ...
      "dashes": false,
      "datasource": "Cloudwatch",
      "description": "Graph metrics at the following address to drill down: https://console.aws.amazon.com/cloudwatch/home?region=${var.region}#metricsV2:graph=~(view~'timeSeries~stacked~false~region~'${var.region}~start~'-PT1H~end~'P0D);search=errors;namespace=Logs;dimensions=CountType,LogGroup",
      "fill": 4,
      "gridPos": {
        "h": 8,
        "w": 12,
